...
import  Reflect  from './Reflect'
 ...
 const Beam = forwardRef(({ children, position, stride = 4, width = 8, ...props }, fRef) => {
  ...
  useFrame(() => {
    ...
    //console.log(reflect.current)
    // console.log('Streaks', streaks.current)
    ...
    streaks.current.instanceMatrix.set(range * 16);
    ...
    glow.current.instanceMatrix.set(range * 16);
